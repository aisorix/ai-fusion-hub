...
const EmptyState = ({ userName }: EmptyStateProps) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-6 sm:py-8 overflow-auto">
      ...
      >
        ...
        <div className="relative mb-4 sm:mb-5 md:mb-6">
          <div className="absolute inset-0 bg-gradient-to-r from-primary/30 to-accent/30 rounded-full blur-2xl scale-150" />
          <img 
            src={sorixLogo} 
            alt="AI Sorix" 
      ...
      >
        {suggestions.map((item, index) => (
          ...
          >
            <div className={cn(
              'w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center transition-all duration-200',
      ...
      <motion.div
        ...
        className="mt-6 sm:mt-8 md:mt-12 flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 text-muted-foreground text-xs sm:text-sm px-2"
      >
