...
const ChatArea = ({ onOpenVoiceMode }: ChatAreaProps) => {
  ...
  return (
    // FIX 1: 'h-[100dvh]' ব্যবহার করা হয়েছে। এটি মোবাইলের অ্যাড্রেস বার সহ পুরো হাইট ক্যালকুলেট করে।

    // 'flex flex-col' নিশ্চিত করে যে ইনপুট বক্স সবসময় নিচে থাকবে।
    ...
    <div className="flex flex-col h-[100dvh] w-full bg-background">
      ...
      {/* FIX 2: 'flex-1' মানে এটি বাকি জায়গা নেবে। 'overflow-y-auto' মানে শুধু এই অংশটুকু স্ক্রল হবে। */}
      ...
      <div className="flex-1 overflow-y-auto min-h-0 w-full">
        {showEmptyState ? (
          ...
          <div className="flex flex-col min-h-full">
            ...
            {/* মেসেজ লিস্টের নিচে একটু ফাঁকা জায়গা, যাতে ইনপুট বক্সের সাথে লেগে না যায় */}
      ...
      {/* FIX 3: 'shrink-0' এবং 'z-20' দেওয়া হয়েছে। এটি ফ্লেক্স কন্টেইনারের একদম নিচে ফিক্সড থাকবে। */}
