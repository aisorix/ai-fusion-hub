    ...
    solutions: {
        ...
        columns: [
            [
                ...
                { icon: Briefcase, name: "Professional Services", desc: "AI consulting & enterprise rollouts", to: "/solutions/ai-for-professionals" },
...
const Navbar = () => {
    ...
    return (
        <>
            <nav
                className={`sticky top-0 z-[100] transition-all duration-500 backdrop-blur-md ${scrolled
                            ...
                            {authLoading ? (
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" className="w-56 backdrop-blur-xl bg-background/80 border-border/50">
                                        ...
                                        <DropdownMenuSeparator className="bg-border/50" />
                                        <DropdownMenuItem asChild>
                                            <Link to="/sorixscholars/dashboard" className="flex items-center gap-2 cursor-pointer focus:bg-primary/10">
