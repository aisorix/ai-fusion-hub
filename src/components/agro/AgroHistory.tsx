...
import { Leaf, Trash2, Loader2, Clock } from 'lucide-react';
import { supabase } from '@/integrations/supabase/client';
import { useAuth } from '@/contexts/AuthContext';
import { cn } from '@/lib/utils';

interface AgroHistoryProps {
...
const AgroHistory: React.FC<AgroHistoryProps> = ({ onLoad }) => {
  const { user } = useAuth();
