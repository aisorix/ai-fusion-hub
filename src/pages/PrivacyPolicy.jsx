...
const PrivacyPolicy = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Account Information:" : "অ্যাকাউন্ট তথ্য:",
          text:
            language === "en"
              ? "Name, email address, phone number, and billing information."
              : "নাম, ইমেইল, ফোন নম্বর এবং বিলিং তথ্য।",
        },
        {
          bold: language === "en" ? "Payment Details:" : "পেমেন্ট বিবরণ:",
          text:
            language === "en"
              ? "Processed securely through SSLCommerz and bKash. We do not store your full card or PIN."
              : "SSLCommerz এবং bKash এর মাধ্যমে নিরাপদে প্রক্রিয়া করা হয়।",
        },
        {
          bold: language === "en" ? "Usage Data:" : "ব্যবহারের ডেটা:",
          text:
            language === "en"
              ? "Tokens used, prompts submitted, AI models selected, and responses."
              : "ব্যবহৃত টোকেন, জমা দেওয়া প্রম্পট, নির্বাচিত AI মডেল।",
        },
        {
          bold: language === "en" ? "Technical Data:" : "প্রযুক্তিগত ডেটা:",
          text:
            language === "en"
              ? "IP address, browser type, device information, and cookies."
              : "IP ঠিকানা, ব্রাউজারের ধরন, ডিভাইসের তথ্য।",
        },
      ],
    },
    {
      ...
      list: [
        {
          text:
            language === "en"
              ? "Provide, personalize, and maintain the AI Sorix platform."
              : "AI Sorix প্ল্যাটফর্ম প্রদান, ব্যক্তিগতকৃত এবং রক্ষণাবেক্ষণ করতে।",
        },
        {
          text:
            language === "en"
              ? "Process subscription payments and credit top-ups."
              : "সাবস্ক্রিপশন পেমেন্ট এবং ক্রেডিট টপ-আপ প্রক্রিয়া করতে।",
        },
        {
          text:
            language === "en"
              ? "Improve our AI models, features, and service quality."
              : "আমাদের AI মডেল, বৈশিষ্ট্য এবং সেবার মান উন্নত করতে।",
        },
        {
          text:
            language === "en"
              ? "Communicate updates, security alerts, and promotional offers."
              : "আপডেট, নিরাপত্তা সতর্কতা এবং প্রচারমূলক অফার জানাতে।",
        },
        {
          text:
            language === "en"
              ? "Ensure platform safety and comply with legal obligations."
              : "প্ল্যাটফর্ম নিরাপত্তা নিশ্চিত করতে এবং আইনি বাধ্যবাধকতা মেনে চলতে।",
        },
      ],
    },
    {
      ...
      content:
        language === "en"
          ? "We value your privacy. We may share limited data only with:"
          : "আমরা আপনার গোপনীয়তাকে মূল্য দিই। আমরা শুধুমাত্র সীমিত ডেটা শেয়ার করতে পারি:",
      list: [
        {
          bold: language === "en" ? "Payment Processors:" : "পেমেন্ট প্রসেসর:",
          text:
            language === "en"
              ? "SSLCommerz, bKash for local payments, and Stripe for international card transactions (Visa, Mastercard, AMEX)."
              : "স্থানীয় পেমেন্টের জন্য SSLCommerz, bKash এবং আন্তর্জাতিক কার্ড লেনদেনের জন্য Stripe (Visa, Mastercard, AMEX)।",
        },
        {
          bold: language === "en" ? "AI Model Providers:" : "AI মডেল প্রদানকারী:",
          text:
            language === "en"
              ? "OpenRouter, OpenAI, Anthropic, Google for responses."
              : "প্রতিক্রিয়ার জন্য OpenRouter, OpenAI, Anthropic, Google।",
        },
        {
          bold: language === "en" ? "Service Providers:" : "সেবা প্রদানকারী:",
          text:
            language === "en" ? "Cloud hosting and analytics partners." : "ক্লাউড হোস্টিং এবং অ্যানালিটিক্স পার্টনার।",
        },
      ],
      note:
        language === "en"
          ? "Note: We accept Stripe for secure international payments. We do not sell your personal data to advertisers or third parties."
          : "দ্রষ্টব্য: আমরা নিরাপদ আন্তর্জাতিক পেমেন্টের জন্য Stripe গ্রহণ করি। আমরা বিজ্ঞাপনদাতা বা তৃতীয় পক্ষের কাছে আপনার ব্যক্তিগত ডেটা বিক্রি করি না।",
    },
    {
    ...
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Access:" : "অ্যাক্সেস:",
          text:
            language === "en" ? "Request a copy of your personal data." : "আপনার ব্যক্তিগত ডেটার একটি কপি অনুরোধ করুন।",
        },
        {
          bold: language === "en" ? "Correction:" : "সংশোধন:",
          text: language === "en" ? "Request correction of inaccurate data." : "ভুল ডেটা সংশোধনের অনুরোধ করুন।",
        },
        {
          bold: language === "en" ? "Deletion:" : "মুছে ফেলা:",
          text:
            language === "en"
              ? "Request permanent deletion of your account."
              : "আপনার অ্যাকাউন্ট স্থায়ীভাবে মুছে ফেলার অনুরোধ করুন।",
        },
        {
          bold: language === "en" ? "Restriction:" : "সীমাবদ্ধতা:",
          text:
            language === "en" ? "Request limits on data processing." : "ডেটা প্রক্রিয়াকরণে সীমাবদ্ধতার অনুরোধ করুন।",
        },
      ],
      note:
        language === "en"
          ? "To exercise these rights, contact us at: support@aisorix.com"
          : "এই অধিকার প্রয়োগ করতে, আমাদের সাথে যোগাযোগ করুন: support@aisorix.com",
    },
    {
            ...
            <article className="bg-gradient-to-br from-primary/10 via-cyan-500/5 to-background border border-primary/20 rounded-xl p-5 sm:p-6 lg:p-8 shadow-sm">
              ...
              <p className="text-muted-foreground text-sm sm:text-base mb-5">
                {language === "en"
                  ...
                  : "প্রশ্ন, সহায়তা বা আইনি নোটিশের জন্য, অনুগ্রহ করে আমাদের সাথে যোগাযোগ করুন:"}
              </p>
