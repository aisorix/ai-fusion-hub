...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-background flex flex-col">
      <SEOHead title="Login | AI Sorix" description="Sign in to your AI Sorix account to access 15+ premium AI models, image generation, presentations, and more." path="/login" />
      {/* Header */}
