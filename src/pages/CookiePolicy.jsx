...
import { ArrowLeft, Cookie, Mail, MapPin, Calendar, Settings, BarChart3, Sparkles, CreditCard, Home, ChevronRight } from 'lucide-react';
  ...
  const cookieTypes = [
    {
      ...
      items: [
        { bold: language === 'en' ? "Authentication:" : "প্রমাণীকরণ:", text: language === 'en' ? "Identify you when you visit." : "আপনি ভিজিট করলে আপনাকে শনাক্ত করে।" },
        { bold: language === 'en' ? "Security:" : "নিরাপত্তা:", text: language === 'en' ? "Detect and prevent security risks." : "নিরাপত্তা ঝুঁকি সনাক্ত এবং প্রতিরোধ করে।" },
        { bold: language === 'en' ? "Credit Tracking:" : "ক্রেডিট ট্র্যাকিং:", text: language === 'en' ? "Track your session usage accurately." : "আপনার সেশন ব্যবহার সঠিকভাবে ট্র্যাক করে।" }
      ],
    ...
    },
    {
      ...
      items: [
        { bold: language === 'en' ? "Purpose:" : "উদ্দেশ্য:", text: language === 'en' ? "Improve website functionality." : "ওয়েবসাইট কার্যকারিতা উন্নত করা।" },
        { bold: language === 'en' ? "Tools:" : "টুলস:", text: language === 'en' ? "Google Analytics, Vercel Analytics." : "Google Analytics, Vercel Analytics।" }
      ],
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <article className="bg-gradient-to-br from-primary/10 via-cyan-500/5 to-background border border-primary/20 rounded-xl p-5 sm:p-6 lg:p-8 shadow-sm">
              ...
              <p className="text-muted-foreground text-sm sm:text-base mb-5">
                {language === 'en' ? 'If you have any questions about our use of cookies, please contact us:' : 'আমাদের কুকি ব্যবহার সম্পর্কে কোনো প্রশ্ন থাকলে, অনুগ্রহ করে আমাদের সাথে যোগাযোগ করুন:'}
              </p>
