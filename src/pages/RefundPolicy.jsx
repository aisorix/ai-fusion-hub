...
const RefundPolicy = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Access Retention:" : "অ্যাক্সেস ধারণ:",
          text:
            language === "en"
              ? "You retain full access to premium features until your current billing cycle ends."
              : "আপনার বর্তমান বিলিং চক্র শেষ না হওয়া পর্যন্ত আপনি প্রিমিয়াম বৈশিষ্ট্যগুলিতে সম্পূর্ণ অ্যাক্সেস পাবেন।",
        },
        {
          bold: language === "en" ? "No Prorated Refunds:" : "কোনো আনুপাতিক রিফান্ড নেই:",
          text:
            language === "en"
              ? "Cancellation does not entitle you to a refund for the remaining period."
              : "বাতিলকরণ আপনাকে অবশিষ্ট সময়ের জন্য রিফান্ডের অধিকার দেয় না।",
        },
        {
          bold: language === "en" ? "Auto-Renewal:" : "স্বয়ংক্রিয় নবায়ন:",
          text:
            language === "en"
              ? "Cancel before your renewal date to avoid being charged for the next cycle."
              : "পরবর্তী চক্রের জন্য চার্জ এড়াতে আপনার নবায়ন তারিখের আগে বাতিল করুন।",
        },
      ],
      note:
        language === "en"
          ? "Cancellation takes effect at the end of your current billing period."
          : "বাতিলকরণ আপনার বর্তমান বিলিং পিরিয়ডের শেষে কার্যকর হয়।",
    },
    {
      title: language === "en" ? "4. Billing Cycle & Access" : "৪. বিলিং চক্র ও অ্যাক্সেস",
      content:
        language === "en"
          ? "Your subscription follows a monthly or yearly billing cycle:"
          : "আপনার সাবস্ক্রিপশন মাসিক বা বার্ষিক বিলিং চক্র অনুসরণ করে:",
      list: [
        {
          bold: language === "en" ? "Monthly Plans:" : "মাসিক প্ল্যান:",
          text: language === "en" ? "Billed on the same date each month." : "প্রতি মাসে একই তারিখে বিল করা হয়।",
        },
        {
          bold: language === "en" ? "Yearly Plans:" : "বার্ষিক প্ল্যান:",
          text:
            language === "en"
              ? "Billed annually with up to 20% savings."
              : "২০% পর্যন্ত সাশ্রয় সহ বার্ষিক বিল করা হয়।",
        },
        {
          bold: language === "en" ? "Failed Payments:" : "ব্যর্থ পেমেন্ট:",
          text:
            language === "en"
              ? "Access may be suspended if payment fails. Service resumes upon successful payment."
              : "পেমেন্ট ব্যর্থ হলে অ্যাক্সেস স্থগিত হতে পারে। সফল পেমেন্টের পর সেবা পুনরায় শুরু হয়।",
        },
      ],
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Duplicate Payments:" : "ডুপ্লিকেট পেমেন্ট:",
          text:
            language === "en"
              ? "If you were charged multiple times for the same transaction."
              : "যদি একই লেনদেনের জন্য আপনাকে একাধিকবার চার্জ করা হয়।",
        },
        {
          bold: language === "en" ? "Technical Errors:" : "প্রযুক্তিগত ত্রুটি:",
          text:
            language === "en"
              ? "System errors that resulted in incorrect charges."
              : "সিস্টেম ত্রুটি যার ফলে ভুল চার্জ হয়েছে।",
        },
        {
          bold: language === "en" ? "Unauthorized Transactions:" : "অননুমোদিত লেনদেন:",
          text:
            language === "en"
              ? "Fraudulent transactions not initiated by you (subject to verification)."
              : "আপনার দ্বারা শুরু করা হয়নি এমন প্রতারণামূলক লেনদেন (যাচাইয়ের সাপেক্ষে)।",
        },
      ],
      note:
        language === "en"
          ? "Requests must be submitted within 7 days of the transaction date."
          : "অনুরোধ লেনদেনের তারিখের ৭ দিনের মধ্যে জমা দিতে হবে।",
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Dispute Window:" : "বিরোধ উইন্ডো:",
          text:
            language === "en"
              ? "7 days from the transaction date (as per Bangladesh Bank guidelines)."
              : "লেনদেনের তারিখ থেকে ৭ দিন (বাংলাদেশ ব্যাংকের নির্দেশিকা অনুযায়ী)।",
        },
        {
          bold: language === "en" ? "Resolution Time:" : "সমাধানের সময়:",
          text:
            language === "en"
              ? "We aim to resolve disputes within 5-7 business days."
              : "আমরা ৫-৭ কার্যদিবসের মধ্যে বিরোধ সমাধান করার লক্ষ্য রাখি।",
        },
        {
          bold: language === "en" ? "SSLCommerz/bKash/Stripe:" : "SSLCommerz/bKash/Stripe:",
          text:
            language === "en"
              ? "Disputes for local payments are handled through respective payment gateway procedures. International Stripe payments follow Stripe's dispute resolution process."
              : "স্থানীয় পেমেন্টের বিরোধ সংশ্লিষ্ট পেমেন্ট গেটওয়ে পদ্ধতির মাধ্যমে পরিচালিত হয়। আন্তর্জাতিক Stripe পেমেন্ট Stripe-এর বিরোধ সমাধান প্রক্রিয়া অনুসরণ করে।",
        },
      ],
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Contact First:" : "প্রথমে যোগাযোগ করুন:",
          text:
            language === "en"
              ? "We encourage you to contact our support team before filing a chargeback."
              : "চার্জব্যাক দাখিল করার আগে আমাদের সাপোর্ট টিমের সাথে যোগাযোগ করার জন্য উৎসাহিত করি।",
        },
        {
          bold: language === "en" ? "Account Suspension:" : "অ্যাকাউন্ট স্থগিত:",
          text:
            language === "en"
              ? "Fraudulent chargebacks will result in permanent account termination."
              : "প্রতারণামূলক চার্জব্যাকের ফলে স্থায়ী অ্যাকাউন্ট বন্ধ হবে।",
        },
      ],
      warning:
        language === "en"
          ? "Fraudulent chargebacks may be reported to relevant authorities."
          : "প্রতারণামূলক চার্জব্যাক সংশ্লিষ্ট কর্তৃপক্ষের কাছে রিপোর্ট করা হতে পারে।",
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "No Payment Required:" : "কোনো পেমেন্ট প্রয়োজন নেই:",
          text:
            language === "en"
              ? "No payment is charged during the trial period."
              : "ট্রায়াল পিরিয়ডে কোনো পেমেন্ট চার্জ করা হয় না।",
        },
        {
          bold: language === "en" ? "Auto-Conversion:" : "স্বয়ংক্রিয় রূপান্তর:",
          text:
            language === "en"
              ? "Your trial may convert to a paid subscription unless cancelled before expiry."
              : "মেয়াদ শেষের আগে বাতিল না করলে আপনার ট্রায়াল পেইড সাবস্ক্রিপশনে রূপান্তরিত হতে পারে।",
        },
        {
          bold: language === "en" ? "Notification:" : "বিজ্ঞপ্তি:",
          text:
            language === "en"
              ? "We will notify you before charging your payment method."
              : "আপনার পেমেন্ট পদ্ধতি চার্জ করার আগে আমরা আপনাকে জানাব।",
        },
      ],
    },
    {
      ...
      list: [
        {
          bold: language === "en" ? "Notice Period:" : "নোটিশ পিরিয়ড:",
          text:
            language === "en"
              ? "At least 30 days notice before price changes take effect."
              : "মূল্য পরিবর্তন কার্যকর হওয়ার কমপক্ষে ৩০ দিন আগে নোটিশ।",
        },
        {
          bold: language === "en" ? "Existing Subscriptions:" : "বিদ্যমান সাবস্ক্রিপশন:",
          text:
            language === "en"
              ? "Current subscribers will be notified via email."
              : "বর্তমান সাবস্ক্রাইবারদের ইমেইলের মাধ্যমে জানানো হবে।",
        },
        {
          bold: language === "en" ? "Cancellation Option:" : "বাতিল অপশন:",
          text:
            language === "en"
              ? "You may cancel before the new price takes effect."
              : "নতুন মূল্য কার্যকর হওয়ার আগে আপনি বাতিল করতে পারেন।",
        },
      ],
    },
  ];
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="text-sm sm:text-base font-semibold text-foreground mb-1">{policy.title}</h3>
          ...
          <div className="space-y-5 sm:space-y-6">
            {sections.map((section, index) => (
              ...
              >
                ...
                {section.content && (
                  <p className="text-muted-foreground text-sm sm:text-base leading-relaxed mb-3">{section.content}</p>
                )}
                {section.list && (
