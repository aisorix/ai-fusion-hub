...
export const WORKSHOPS: WorkshopData[] = [
  {
    ...
    desc: "আপনার সুনির্দিষ্ট লক্ষ্য অর্জনে এবং পেশাগত ক্ষেত্রে এআই (AI) প্রযুক্তির সঠিক প্রয়োগ নিশ্চিত করতে আমাদের প্রাইভেট ব্যাচে অংশগ্রহণ করুন।",
    price: "৳2999",
  ...
  },
  {
    ...
    desc: "কর্পোরেট রেসে সবার চেয়ে এগিয়ে থাকতে এআই (AI) শেখা এখন ১০০% আবশ্যিক! আপনার ১ ঘণ্টার কাজ মাত্র ৫ মিনিটে নামিয়ে আনার জাদুকরী ট্রিকস শিখতে আজই জয়েন করুন এই ধামাকা প্র্যাক্টিক্যাল সেশনে!",
    price: "৳399",
    oldPrice: "৳৯৯৯",
    date: "",//"১৬, ১৭, ১৮ জুলাই",
    time: "",//"রাত ৯ টা",
